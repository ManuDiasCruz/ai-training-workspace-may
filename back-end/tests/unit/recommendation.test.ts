...
describe("UNIT TESTS SUITE", () => {
    ...
    describe("Random recommendations tests", () => {
        ...
        it("Error notfound in get random", async () => {
            ...
            // getByScore falls back to an unfiltered findAll when the filtered
            // query is empty, so both calls have to be mocked -- otherwise this
            // "unit" test silently queries the real database.
            jest
                .spyOn(recommendationRepository, "findAll")
