...
describe("UNIT TESTS SUITE", () => {
    ...
    describe("Random recommendations tests", () => {
        ...
        it("Error notfound in get random", async () => {
            ...
            // getByScore falls back to an unfiltered findAll() when the
            // filtered one comes back empty, so both calls need a mock -
            // otherwise the second one reached the real database.
            jest
                .spyOn(recommendationRepository, "findAll")
