...
describe("INTEGRATION TESTS SUITE", () => {
    ...
    describe("GET /recommendations", () => {
        it("List recommendations", async () => {
            ...
            // recommendationRepository.findAll orders by `id: "desc"`, so the
            // most recently inserted recommendation comes first. The previous
            // expectation asked for [2, 1, 3], which no ordering produces.
